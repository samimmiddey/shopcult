...
const ReviewProducts = ({ loading }) => {
   ...
   const discountError = useSelector(state => state.ui.discountError);
   const discountErrorText = useSelector(state => state.ui.discountErrorText);
